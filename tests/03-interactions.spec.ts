...
test.beforeEach(async ({ page }) => {
    ...
    await expect(
        // Remove EXIT_EDIT_MODE_OLD after Home Assistant 2025.8.1
        page.locator(EXIT_EDIT_MODE_OLD).or(page.locator(EXIT_EDIT_MODE))
    ).toBeVisible();
...
test('Edit a storage mode dashboard', async ({ page }) => {
    ...
    await expect(page.locator(TABS_CONTENT_SELECTOR)).toHaveScreenshot('01-storage-mode-edit-view.png');
    // Remove EXIT_EDIT_MODE_OLD after Home Assistant 2025.8.1
    await page.locator(EXIT_EDIT_MODE_OLD).or(page.locator(EXIT_EDIT_MODE)).click();
...
test('Adding a new view', async ({ page }) => {
    ...
    // Remove EXIT_EDIT_MODE_OLD after Home Assistant 2025.8.1
    const exitEditMode = page.locator(EXIT_EDIT_MODE_OLD).or(page.locator(EXIT_EDIT_MODE));
